...
| `*.html`(不帶後綴) | 瀏覽模式(整頁捲動 / 互動學習頁面) | Part 1～3、`ai-policy`、`anthropic-academy`: Claude Code 透過 `/md2course` 轉換為互動學習頁面; 其餘教材: [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) 輸出 HTML |
