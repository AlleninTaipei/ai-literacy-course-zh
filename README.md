...
將課程連結貼進 Notebook LM , 讓他生成 “資訊圖表”, “簡報”, “語音摘要”; 先看一頁的 “資訊圖表”, 接著兩倍速聽 “語音摘要” 的同時開啟 ”簡報” 進行瀏覽.

迅速吸收新知, 檢視自己的報告, 準備考試, 都可以用這套; 各位可以用這套進行課後回顧, 推廣 Notebook LM 是現代職場工作者和學生一定要認識的一項 AI 工具.

華擎旗艦 Taichi 系列迎來十周年里程碑 - 我用 "太極" 為 AI 驅動個人成長的旅程做個 Opening.
